...
// ── Deteksi Konfigurasi OpenSSL secara Global ────────────────
$possibleCnf = [
...
$globalOpensslCnf = null;
foreach ($possibleCnf as $path) {
    if (file_exists($path)) {
        $globalOpensslCnf = $path;
        break;
    }
}
...
if ($page === 'rsa') {
    if (isset($_POST['regenerate'])) {
        ...
        header("Location: " . $_SERVER['PHP_SELF'] . "?page=rsa");
        exit;
    }
    ...
    if (!isset($_SESSION['alice_private']) || !isset($_SESSION['alice_public'])) {
        ...
        if ($globalOpensslCnf) {
            $rsa_config['config'] = $globalOpensslCnf;
        }
...
function navItem(string $p, string $current, string $icon, string $label): string {
    ...
    return '<a href="index.php?page=' . $p . '" class="dropdown-item' . $active . '" role="menuitem">' . $icon . ' ' . $label . '</a>';
}
?>
<!DOCTYPE html>
<html lang="id">
...
<nav class="navbar" role="navigation" aria-label="Main navigation">
  <div class="nav-container">
    <a href="index.php?page=home" class="logo">🔬 CryptoLab</a>
...
<div class="container">
  ...
  <div class="projects-grid">
    <a href="index.php?page=fpb" class="project-card">
    ...
    <a href="index.php?page=kripto" class="project-card">
    ...
    <a href="index.php?page=rsa" class="project-card">
    ...
    <a href="index.php?page=verifikator" class="project-card">
    ...
    <a href="index.php?page=ssl" class="project-card">
    ...
    <a href="index.php?page=xor" class="project-card">
    ...
    <a href="index.php?page=sha256" class="project-card">
...
<div class="wrapper-sm">
  <div class="card">
    ...
    <form method="POST" action="index.php?page=fpb" id="fpb-form">
      <div class="num-row">
...
<div class="wrapper">
  <div class="card">
    ...
    <form method="POST" action="index.php?page=kripto" id="crypto-form">
  ...
  <div class="steps-list">
    ...
    <div class="step-card step-alice">
      ...
      <div class="step-body">
        ...
        <form method="post" action="index.php?page=rsa" style="margin-top:1rem;border-top:1px solid var(--border);padding-top:1rem;">
    ...
    <div class="step-card step-bob">
      ...
      <div class="step-body">
        <form method="post" action="index.php?page=rsa">
          <div class="field">
...
<div class="verif-wrapper">
  ...
  <div class="verif-step">
    ...
    <form method="post" action="index.php?page=verifikator">
...
<div class="ssl-main">
  ...
  <div class="ssl-form-panel">
    ...
    <form method="post" action="index.php?page=ssl" id="ssl-form" novalidate>
...
<div class="wrapper">
  ...
  <div class="main-card">
    ...
    <form method="POST" action="index.php?page=xor" id="xor-form">
...
<div class="wrapper">
  ...
  <div class="main-card">
    ...
    <form method="POST" action="index.php?page=sha256" id="sha-form">
...
function resetFPB() {
  ...
  if (a1) a1.value = '';
  if (a2) a2.value = '';
  window.location.href = 'index.php?page=fpb';
}
